...
void LoginDatabaseConnection::DoPrepareStatements()
{
	...
	PrepareStatement(LOGIN_SEL_ALLRANDOM_NAME, "SELECT name_id, name FROM playerbot_names", CONNECTION_SYNCH);
	PrepareStatement(LOGIN_SEL_ALLARENA_NAME, "SELECT name_id, name FROM playerbot_guild_names", CONNECTION_SYNCH);
}
