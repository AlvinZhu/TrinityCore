...
namespace
{
    ...
    public:
		...
		std::string GetGossipText(Player* player, const char* baseText, TransmogTrinityStrings tsType)
		{
			WorldSession* session = player->GetSession();
			std::string text = baseText;
			const char* tsText = session->GetTrinityString(tsType);
			if (tsText)
				text += tsText;
			return text;
		}
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
			...
			if (sTransmogrification->EnableTransmogInfo)
			{
				...
				player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_HAND), EQUIPMENT_SLOT_END + 9, 0);
			}
			...
			if (sTransmogrification->EnableSets)
			{
				...
				player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_SETS), EQUIPMENT_SLOT_END + 4, 0);
			}
#endif
			...
			player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_REMOVEALL), EQUIPMENT_SLOT_END + 2, 0, "Remove transmogrifications from all equipped items?", 0, false);
			...
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_UPDATEMENU), EQUIPMENT_SLOT_END + 1, 0);
            ...
            switch (sender)
            {
                ...
                case EQUIPMENT_SLOT_END + 4: // Presets menu
                {
					...
					if (sTransmogrification->EnableSetInfo)
					{
						...
						player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_SETOPT), EQUIPMENT_SLOT_END + 10, 0);
					}
                    ...
                    if (!player->presetMap.empty())
                    {
						...
						if (player->presetMap.size() < sTransmogrification->MaxSets)
						{
							...
							player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_SAVESET), EQUIPMENT_SLOT_END + 8, 0);
						}
                    }
					else
					{
					...
					player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_BACK), EQUIPMENT_SLOT_END + 1, 0);
					player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
                ...
                case EQUIPMENT_SLOT_END + 6: // view preset
                {
					...
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/INV_Misc_Statue_02:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_USESET), EQUIPMENT_SLOT_END + 5, action, "Using this set for transmogrify will bind transmogrified items to you and make them non-refundable and non-tradeable.\nDo you wish to continue?\n\n" + it->second.name, 0, false);
					...
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/PaperDollInfoFrame/UI-GearManager-LeaveItem-Opaque:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_DELSET), EQUIPMENT_SLOT_END + 7, action, "Are you sure you want to delete " + it->second.name + "?", 0, false);
					//player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tBack..", EQUIPMENT_SLOT_END + 4, 0);
					player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_BACK), EQUIPMENT_SLOT_END + 4, 0);
					player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
                ...
                case EQUIPMENT_SLOT_END + 8: // Save preset
                {
					...
					if (canSave)
					{
						...
						player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_SAVESET), 0, 0, "Insert set name", cost*sTransmogrification->SetCostModifier + sTransmogrification->SetCopperCost, true);
					}
					...
					player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_UPDATEMENU), sender, action);
					//player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tBack..", EQUIPMENT_SLOT_END + 4, 0);
					player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_BACK), EQUIPMENT_SLOT_END + 4, 0);
					player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
        ...
        void ShowTransmogItems(Player* player, Creature* creature, uint8 slot) // Only checks bags while can use an item from anywhere in inventory
        {
			...
			player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_TRANS_REMOVE), EQUIPMENT_SLOT_END + 3, slot, "Remove transmogrification from the slot?", 0, false);
			...
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_UPDATEMENU), EQUIPMENT_SLOT_END, slot);
            //player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tBack..", EQUIPMENT_SLOT_END + 1, 0);
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, GetGossipText(player, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|t", TransmogTrinityStrings::LANG_MENU_ITEM_BACK), EQUIPMENT_SLOT_END + 1, 0);
			player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
        }
