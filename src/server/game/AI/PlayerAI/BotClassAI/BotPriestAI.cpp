...
{
	PriestIDLE_AllHardRes = FindMaxRankSpellByExist(48162);
	PriestIDLE_HardRes = FindMaxRankSpellByExist(48161);
	PriestIDLE_SoulFire = FindMaxRankSpellByExist(48168);
	PriestIDLE_AllSpiritRes = FindMaxRankSpellByExist(48074);
	PriestIDLE_SpiritRes = FindMaxRankSpellByExist(48073);
	PriestIDLE_Bloodsucker = FindMaxRankSpellByExist(15286);
	PriestIDLE_AllShadowRes = FindMaxRankSpellByExist(48170);
	PriestIDLE_ShadowRes = FindMaxRankSpellByExist(48169);
	PriestIDLE_ShadowStatus = FindMaxRankSpellByExist(15473);

	PriestGuard_ShadowFear = FindMaxRankSpellByExist(64044);
	PriestGuard_AOEFear = FindMaxRankSpellByExist(10890);
	...
	PriestGuard_DefShield = FindMaxRankSpellByExist(48066);
	PriestGuard_SelfHealth = FindMaxRankSpellByExist(48173);
	PriestGuard_GuardSoul = FindMaxRankSpellByExist(47788);

	PriestAssist_SoulAbs = FindMaxRankSpellByExist(14751);
	PriestAssist_AddHolyPower = FindMaxRankSpellByExist(10060);
	PriestAssist_AllDispel = FindMaxRankSpellByExist(32375);
	PriestAssist_Dispel = FindMaxRankSpellByExist(988);
	PriestAssist_ShadowDemon = FindMaxRankSpellByExist(34433);
	PriestAssist_Silence = FindMaxRankSpellByExist(15487);
	PriestAssist_AllResMana = FindMaxRankSpellByExist(64901);
	PriestAssist_AllResLife = FindMaxRankSpellByExist(64843);

	PriestDebuf_Ache = FindMaxRankSpellByExist(48125);
	PriestDebuf_Drown = FindMaxRankSpellByExist(48158);
	PriestDebuf_Plague = FindMaxRankSpellByExist(48300);
	PriestAOE_ShadowExplode = FindMaxRankSpellByExist(53023);
	PriestAOE_HolyNova = FindMaxRankSpellByExist(48078);

	PriestShadow_ShadowTouch = FindMaxRankSpellByExist(48160);
	PriestShadow_Knocking = FindMaxRankSpellByExist(48127);
	PriestShadow_Lech = FindMaxRankSpellByExist(48156);
	PriestHoly_Smite = FindMaxRankSpellByExist(48123);
	PriestHoly_BigFire = FindMaxRankSpellByExist(48135);
	PriestPrecept_ManaBurn = FindMaxRankSpellByExist(8129);

	PriestHeal_LowHeal = FindMaxRankSpellByExist(6064);
	PriestHeal_Resume = FindMaxRankSpellByExist(48068);
	PriestHeal_FastHeal = FindMaxRankSpellByExist(48071);
	PriestHeal_BigHeal = FindMaxRankSpellByExist(48063);
	PriestHeal_LinkHeal = FindMaxRankSpellByExist(48120);
	PriestHeal_UnionHeal = FindMaxRankSpellByExist(48113);
	PriestHeal_RingHeal = FindMaxRankSpellByExist(48089);
	PriestHeal_AOEHeal = FindMaxRankSpellByExist(48072);
	PriestHeal_Awareness = FindMaxRankSpellByExist(53007);
