...
{
	MageIDLE_ManaGem = FindMaxRankSpellByExist(42985);
	MageIDLE_ArcaneMagic = FindMaxRankSpellByExist(42995);
	MageIDLE_AOEArcaneMagic = FindMaxRankSpellByExist(43002);
	MageIDLE_MgcArmor = FindMaxRankSpellByExist(43024);
	MageIDLE_FrostArmor = FindMaxRankSpellByExist(43008);
	MageIDLE_IceArmor = FindMaxRankSpellByExist(7301);
	MageIDLE_FireArmor = FindMaxRankSpellByExist(43046);
	MageIDLE_MagicAdd = FindMaxRankSpellByExist(43017);
	MageIDLE_MagicDec = FindMaxRankSpellByExist(43015);
	MageIDLE_SummonRite = FindMaxRankSpellByExist(58659);

	MageGuard_MagicShield = FindMaxRankSpellByExist(43020);
	MageGuard_FrostShield = FindMaxRankSpellByExist(43039);
	MageGuard_FrostScherm = FindMaxRankSpellByExist(45438);
	MageGuard_FrostNova = FindMaxRankSpellByExist(42917);
	MageGuard_FireBreath = FindMaxRankSpellByExist(42950);
	MageGuard_FireNova = FindMaxRankSpellByExist(42945);

	MageAssist_Mirror = FindMaxRankSpellByExist(55342);
	MageAssist_Rouse = FindMaxRankSpellByExist(12051);
	MageAssist_Stealth = FindMaxRankSpellByExist(66);
	MageAssist_Teleport = FindMaxRankSpellByExist(1953);
	MageAssist_DecCurse = FindMaxRankSpellByExist(475);
	MageAssist_Grace = FindMaxRankSpellByExist(12043);
	MageAssist_ArcanePower = FindMaxRankSpellByExist(12042);
	MageAssist_CastSpeed = FindMaxRankSpellByExist(12472);
	MageAssist_FastColddown = FindMaxRankSpellByExist(11958);
	MageAssist_FrostPet = FindMaxRankSpellByExist(31687);
	MageAssist_FireCritAura = FindMaxRankSpellByExist(11129);

	MageConfine_BreakCast = FindMaxRankSpellByExist(2139);
	MageConfine_AuraSteal = FindMaxRankSpellByExist(30449);
	MageConfine_ArcaneSlow = FindMaxRankSpellByExist(31589);
	MageConfine_ToSheep = FindMaxRankSpellByExist(12826);
	MageConfine_Freeze = FindMaxRankSpellByExist(44572);

	MageAOE_ArcaneExplode = FindMaxRankSpellByExist(42921);
	MageAOE_Snowstorm = FindMaxRankSpellByExist(42940);
	MageAOE_IcePiton = FindMaxRankSpellByExist(42931);
	MageAOE_FireStorm = FindMaxRankSpellByExist(42926);

	MageArcane_Barrage = FindMaxRankSpellByExist(44781);
	MageArcane_Bullet = FindMaxRankSpellByExist(42846);
	MageArcane_ArcaneShock = FindMaxRankSpellByExist(42897);
	MageFrost_IceArrow = FindMaxRankSpellByExist(42842);
	MageFrost_IceLance = FindMaxRankSpellByExist(42914);
	MageFrost_FFArrow = FindMaxRankSpellByExist(47610);
	MageFire_FireArrow = FindMaxRankSpellByExist(42833);
	MageFire_FireShock = FindMaxRankSpellByExist(42873);
	MageFire_Firing = FindMaxRankSpellByExist(42859);
	MageFire_BigFireBall = FindMaxRankSpellByExist(42891);
	MageFire_FireBomb = FindMaxRankSpellByExist(55360);
...
void BotMageAI::OnCastPolymorph(Unit* pTarget)
{
	...
	if (me->GetTarget() == m_LastPolymorphTarget)
...
bool BotMageAI::TryStartControlCommand()
{
	...
	SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(MageConfine_ToSheep);
...
Item* BotMageAI::FindExistManaJewel()
{
	for (uint8 slot = InventoryPackSlots::INVENTORY_SLOT_ITEM_START; slot < InventoryPackSlots::INVENTORY_SLOT_ITEM_END; slot++)
	{
		...
		if (!pTemplate)
			continue;
		if (m_JewelEntrys.find(pTemplate->ItemId) != m_JewelEntrys.end())
			return pItem;
	}
