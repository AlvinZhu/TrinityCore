...
{
	DruidIDLE_AOEFerityWish = FindMaxRankSpellByExist(48470);

	DruidStatus_Travel = FindMaxRankSpellByExist(783);
	DruidStatus_Bear = FindMaxRankSpellByExist(9634);
	...
	DruidGuard_Harden = FindMaxRankSpellByExist(22812);
	DruidGuard_Thorns = FindMaxRankSpellByExist(53307);
	DruidGuard_AutoTwine = FindMaxRankSpellByExist(53312);
	DruidGuard_Twine = FindMaxRankSpellByExist(53308);
	DruidGuard_Control = FindMaxRankSpellByExist(33786);
	DruidGuard_Pofu = FindMaxRankSpellByExist(61336);
	DruidGuard_TreeMan = FindMaxRankSpellByExist(33831);

	DruidAssist_PersonSpirit = FindMaxRankSpellByExist(770);
	DruidAssist_BeastSpirit = FindMaxRankSpellByExist(16857);
	DruidAssist_Active = FindMaxRankSpellByExist(29166);

	DruidCast_Moonfire = FindMaxRankSpellByExist(48463);
	DruidCast_Insect = FindMaxRankSpellByExist(48468);
	DruidCast_Anger = FindMaxRankSpellByExist(48461);
	DruidCast_Spark = FindMaxRankSpellByExist(48465);

	DruidAOE_Hurricane = FindMaxRankSpellByExist(48467);
	DruidAOE_Typhoon = FindMaxRankSpellByExist(61384);
	DruidAOE_FallStar = FindMaxRankSpellByExist(48505);

	DruidHeal_Nourishing = FindMaxRankSpellByExist(50464);
	DruidHeal_Relife = FindMaxRankSpellByExist(48441);
	DruidHeal_Coalescence = FindMaxRankSpellByExist(48443);
	DruidHeal_Touch = FindMaxRankSpellByExist(48378);
	DruidHeal_LifeBurst = FindMaxRankSpellByExist(48451);
	DruidHeal_MergerLife = FindMaxRankSpellByExist(18562);
	DruidHeal_MomentHeal = FindMaxRankSpellByExist(17116);

	DruidHeal_AOETranquility = FindMaxRankSpellByExist(48447);
	DruidHeal_AOEFerity = FindMaxRankSpellByExist(53251);

	DruidCat_Stun = FindMaxRankSpellByExist(49802);
	DruidCat_Bite = FindMaxRankSpellByExist(48577);
	DruidCat_Roar = FindMaxRankSpellByExist(52610);
	DruidCat_Separate = FindMaxRankSpellByExist(49800);

	DruidCat_Tiger = FindMaxRankSpellByExist(50213);
	DruidCat_FastMove = FindMaxRankSpellByExist(33357);
	DruidCat_Charge = FindMaxRankSpellByExist(49376);
	DruidCat_Surprise = FindMaxRankSpellByExist(49803);
	DruidCat_Sack = FindMaxRankSpellByExist(48579);
	DruidCat_Claw = FindMaxRankSpellByExist(48570);
	DruidCat_BackStab = FindMaxRankSpellByExist(48572);
	DruidCat_Attack = FindMaxRankSpellByExist(62078);
	DruidCat_Sweep = FindMaxRankSpellByExist(48574);
	DruidCat_Laceration = FindMaxRankSpellByExist(48566);

	DruidBear_DecAtt = FindMaxRankSpellByExist(48560);
	DruidBear_AddPower = FindMaxRankSpellByExist(5229);
	DruidBear_PowerLife = FindMaxRankSpellByExist(22842);
	DruidBear_Laceration = FindMaxRankSpellByExist(48564);
	DruidBear_Sweep = FindMaxRankSpellByExist(48568);
	DruidBear_Attack = FindMaxRankSpellByExist(48562);
	DruidBear_NextAtt = FindMaxRankSpellByExist(48480);
	DruidBear_Stun = FindMaxRankSpellByExist(8983);
	DruidBear_Charge = FindMaxRankSpellByExist(16979);
}
...
bool BotDruidAI::TryStartControlCommand()
{
	...
	SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(DruidGuard_Control);
