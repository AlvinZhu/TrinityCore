...
Item* BotUtility::StoreNewItemByEntry(Player* player, uint32 entry, int32 count)
{
	...
	if (count <= 0 || dest.empty())
		return NULL;
	Item* itemInst = player->StoreNewItem(dest, pTemplate->ItemId, true, Item::GenerateItemRandomPropertyId(pTemplate->ItemId));
	return itemInst;
}
