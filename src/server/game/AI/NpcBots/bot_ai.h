...
//COMMON GOSSIPS
	...
	GOSSIP_SENDER_CLASS = 6001,
	GOSSIP_SENDER_EQUIPMENT = 6002,
	GOSSIP_SENDER_EQUIPMENT_LIST = 6003,
	GOSSIP_SENDER_EQUIPMENT_SHOW = 6004,
	GOSSIP_SENDER_EQUIPMENT_INFO = 6005,
	GOSSIP_SENDER_UNEQUIP = 6006,
	GOSSIP_SENDER_EQUIP_RESET = 6007,
	GOSSIP_SENDER_EQUIP = 6008,
	GOSSIP_SENDER_EQUIP_BEGIN = GOSSIP_SENDER_EQUIP,
	GOSSIP_SENDER_EQUIP_MHAND = GOSSIP_SENDER_EQUIP_BEGIN,
	GOSSIP_SENDER_EQUIP_OHAND = 6009,
	GOSSIP_SENDER_EQUIP_RANGED = 6010,
	GOSSIP_SENDER_EQUIP_HEAD = 6011,
	GOSSIP_SENDER_EQUIP_SHOULDERS = 6012,
	GOSSIP_SENDER_EQUIP_CHEST = 6013,
	GOSSIP_SENDER_EQUIP_WAIST = 6014,
	GOSSIP_SENDER_EQUIP_LEGS = 6015,
	GOSSIP_SENDER_EQUIP_FEET = 6016,
	GOSSIP_SENDER_EQUIP_WRIST = 6017,
	GOSSIP_SENDER_EQUIP_HANDS = 6018,
	GOSSIP_SENDER_EQUIP_BACK = 6019,
	GOSSIP_SENDER_EQUIP_BODY = 6020,
	GOSSIP_SENDER_EQUIP_FINGER1 = 6021,
	GOSSIP_SENDER_EQUIP_FINGER2 = 6022,
	GOSSIP_SENDER_EQUIP_TRINKET1 = 6023,
	GOSSIP_SENDER_EQUIP_TRINKET2 = 6024,
	GOSSIP_SENDER_EQUIP_NECK = 6025,
	GOSSIP_SENDER_ROLES = 6026,
	GOSSIP_SENDER_ROLES_TOGGLE = 6027,
	GOSSIP_SENDER_ABILITIES = 6028,
	GOSSIP_SENDER_ABILITIES_USE = 6029,
//COMMON GAMEEVENTS
...
class bot_ai : public ScriptedAI
{
    ...
    protected:
        ...
        inline bool IsChanneling(Unit* u = NULL) const { if (!u) u = me; return (u->GetCurrentSpell(CURRENT_CHANNELED_SPELL)) != 0; }
