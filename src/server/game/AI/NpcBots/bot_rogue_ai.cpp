...
return;
		...
		if (_isnan(dist))
            ...
            if ( irand(0,8)==1 && GetHealthPCT(me) < 50 )
            {
                doCast(me, 41455);
return;
            } 

          if (irand(0,28)==2 && lvl>=80)
            {
            doCast(opponent, 65955);            
return;
            }
else
          if (irand(0,28)==3 && lvl>=80)
            {
            doCast(opponent, 65960);            
return;
            }
else
          if (irand(0,28)==4 && lvl>=80)
            {
            doCast(opponent, 65956);            
return;
            }
else
          if (irand(0,28)==5 && lvl>=80)
            {
            doCast(opponent, 65954);            
return;
            }
else

          if (irand(0,28)==6 && lvl>=80)
            {
            doCast(opponent, 65957);            
return;
            }
else
...
return;
           ...
           if ( irand(0,20)==1 && GetHealthPCT(me) < 70)
            {
                doCast(me, 22857);
return;
            }     
...
return;
           ...
           if ( irand(0,16)==4 && meleedist <= 2)
            {
                doCast(opponent, 40504);
return;
            }  
          else  
           if ( irand(0,16)==5 && meleedist <= 2)
            {
