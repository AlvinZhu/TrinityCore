...
return;
            ...
            if ( irand(0,28)==1  && lvl<80)
            {
                doCast(opponent, 27348);
return;
            }
            if ( irand(0,28)==1  && lvl<80)
            {
                doCast(opponent, 27347);
return;
            }
            if ( irand(0,28)==1 && meleedist < 2  && lvl<80)
            {
                doCast(opponent, 35308);
return;
            }
...
return;
            ...
            if ( irand(1,28)==1 && meleedist < 2 && lvl<80 )
            {
...
return;
        ...
        if (irand(0,28)==6 && lvl>=80 && meleedist > 10)
            {
            doCast(opponent, 71126);            
            return;
            }
else

          if (irand(0,28)==1 && lvl>=80 && meleedist > 10)
            {
            doCast(opponent, 65866);            
            return;
            }

else

          if (irand(0,28)==2 && lvl>=80 && meleedist > 10)
            {
            doCast(opponent, 65867);            
            return;
            }
else

          if (irand(0,28)==3 && lvl>=80 && meleedist > 10)
            {
            doCast(opponent, 65868);            
            return;
            }
else
          if (irand(0,28)==4 && lvl>=80 && meleedist > 10)
            {
            doCast(opponent, 65877);            
            return;
            }   

          if (irand(0,28)==5 && lvl>=80 && meleedist < 5)
            {
            doCast(opponent, 66207);            
            return;
            }  

          if (irand(0,25)==6 && lvl>=70 && meleedist > 6)
            {
            doCast(opponent, 71250);            
            return;
            }

          if (irand(0,25)==6 && lvl>=70 && meleedist > 6)
            {
            doCast(opponent, 59147);            
            return;
            }
