...
public:
    ...
    struct bot_druid_ai : public bot_minion_ai
    {
		...
		return;
            ...
            if (irand(0,28)==2 && GetHealthPCT(me) < 50   && lvl>=80)
            {
               doCast(me, 69923);
               return;
...
return;
                    ...
                    if (angle < 8 && irand(0,28)==1 && lvl>=80)
                    {
                    doCast(opponent, 40936);        
return;
                } 

                  else  if (angle > 10 && irand(0,28)==1 && lvl>=80)
                    {
                    doCast(opponent, 65854);        
return;
                } 
                  else  if (angle > 10 && irand(0,28)==2 && lvl>=80)
                    {
                    doCast(opponent, 65856);        
return;
                } 

                  else  if (angle > 10 && irand(0,28)==3 && lvl>=80)
                    {
                    doCast(opponent, 65857);        
return;
                } 

                  else  if (angle > 10 && irand(0,28)==4 && lvl>=80)
                    {
                    doCast(opponent, 65863);        
return;
                } 
